...
/**
 * Upload dist/ to:
 *   1) R2 26-hb-ds-pacs-assets  (project bucket)
 *   2) R2 allworld-sites/26-hb-ds-pacs/  (shared Allworld host)
...
const siteId = process.argv[2] || '26-hb-ds-pacs'
const projectBucket = '26-hb-ds-pacs-assets'
